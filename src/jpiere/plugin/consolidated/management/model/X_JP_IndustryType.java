...
@org.adempiere.base.Model(table="JP_IndustryType")
public class X_JP_IndustryType extends PO implements I_JP_IndustryType, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_JP_IndustryType (Properties ctx, int JP_IndustryType_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_IndustryType_ID, trxName, virtualColumns);
      /** if (JP_IndustryType_ID == 0)
        {
			setJP_IndustryType_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_JP_IndustryType (Properties ctx, String JP_IndustryType_UU, String trxName)
    {
      super (ctx, JP_IndustryType_UU, trxName);
      /** if (JP_IndustryType_UU == null)
        {
			setJP_IndustryType_ID (0);
			setName (null);
			setValue (null);
    ...
    /** Standard Constructor */
    public X_JP_IndustryType (Properties ctx, String JP_IndustryType_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_IndustryType_UU, trxName, virtualColumns);
      /** if (JP_IndustryType_UU == null)
        {
			setJP_IndustryType_ID (0);
			setName (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_IndustryType[")
	...
	*/
	...
	{
		return (I_JP_IndustryTypeL1)MTable.get(getCtx(), I_JP_IndustryTypeL1.Table_ID)
