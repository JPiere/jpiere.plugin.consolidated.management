...
@org.adempiere.base.Model(table="JP_IndustryTypeL1")
public class X_JP_IndustryTypeL1 extends PO implements I_JP_IndustryTypeL1, I_Persistent
{
    ...
    /** Standard Constructor */
    public X_JP_IndustryTypeL1 (Properties ctx, int JP_IndustryTypeL1_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_IndustryTypeL1_ID, trxName, virtualColumns);
      /** if (JP_IndustryTypeL1_ID == 0)
        {
			setJP_IndustryTypeL1_ID (0);
			setName (null);
    ...
    /** Standard Constructor */
    public X_JP_IndustryTypeL1 (Properties ctx, String JP_IndustryTypeL1_UU, String trxName)
    {
      super (ctx, JP_IndustryTypeL1_UU, trxName);
      /** if (JP_IndustryTypeL1_UU == null)
        {
			setJP_IndustryTypeL1_ID (0);
			setName (null);
			setValue (null);
    ...
    /** Standard Constructor */
    public X_JP_IndustryTypeL1 (Properties ctx, String JP_IndustryTypeL1_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_IndustryTypeL1_UU, trxName, virtualColumns);
      /** if (JP_IndustryTypeL1_UU == null)
        {
			setJP_IndustryTypeL1_ID (0);
			setName (null);
    ...
    {
      StringBuilder sb = new StringBuilder ("X_JP_IndustryTypeL1[")
	...
	*/
	...
	{
		return (I_JP_IndustryTypeL2)MTable.get(getCtx(), I_JP_IndustryTypeL2.Table_ID)
