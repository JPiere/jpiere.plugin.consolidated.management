...
@org.adempiere.base.Model(table="JP_BillSchema")
...
// N
    ...
    /** Standard Constructor */
    public X_JP_BillSchema (Properties ctx, int JP_BillSchema_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_BillSchema_ID, trxName, virtualColumns);
      /** if (JP_BillSchema_ID == 0)
        {
			setC_DocType_ID (0);
			setIsBillOrgJP (false);
...
// N
    ...
    /** Standard Constructor */
    public X_JP_BillSchema (Properties ctx, String JP_BillSchema_UU, String trxName)
    {
      super (ctx, JP_BillSchema_UU, trxName);
      /** if (JP_BillSchema_UU == null)
        {
			setC_DocType_ID (0);
			setIsBillOrgJP (false);
// N
...
// N
    ...
    /** Standard Constructor */
    public X_JP_BillSchema (Properties ctx, String JP_BillSchema_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, JP_BillSchema_UU, trxName, virtualColumns);
      /** if (JP_BillSchema_UU == null)
        {
			setC_DocType_ID (0);
			setIsBillOrgJP (false);
...
// N
	...
	*/
	...
	/** Set Charge of Tax Adjust Invoice.
		@param JP_TaxAdjust_Charge_ID JPIERE-0508:JPBP
	*/
	...
	/** Set Description of Tax Adjust Invoice.
		@param JP_TaxAdjust_Description JPIERE-0508:JPBP
	*/
	...
	/** Set Doc Type of Tax Adjust Invoice.
		@param JP_TaxAdjust_DocType_ID JPIERE-0508:JPBP
	*/
	...
	/** Set Price List of Tax Adjust Invoice.
		@param JP_TaxAdjust_PriceList_ID JPIERE-0508:JPBP
	*/
	...
	/** Set Tax of Tax Adjust Invoice.
		@param JP_TaxAdjust_Tax_ID JPIERE-0508:JPBP
	*/
