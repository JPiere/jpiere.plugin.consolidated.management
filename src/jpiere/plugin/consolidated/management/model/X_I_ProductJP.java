...
@org.adempiere.base.Model(table="I_ProductJP")
public class X_I_ProductJP extends PO implements I_I_ProductJP, I_Persistent
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20241126L;
...
// N
    ...
    /** Standard Constructor */
    public X_I_ProductJP (Properties ctx, int I_ProductJP_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, I_ProductJP_ID, trxName, virtualColumns);
      /** if (I_ProductJP_ID == 0)
        {
			setGuaranteeDays (0);
// 0
...
// N
    ...
    /** Standard Constructor */
    public X_I_ProductJP (Properties ctx, String I_ProductJP_UU, String trxName)
    {
      super (ctx, I_ProductJP_UU, trxName);
      /** if (I_ProductJP_UU == null)
        {
			setGuaranteeDays (0);
// 0
			setI_IsActiveJP (true);
...
// N
    ...
    /** Standard Constructor */
    public X_I_ProductJP (Properties ctx, String I_ProductJP_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, I_ProductJP_UU, trxName, virtualColumns);
      /** if (I_ProductJP_UU == null)
        {
			setGuaranteeDays (0);
// 0
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_I_ProductJP[")
	...
	*/
	...
	/** Set Consolidated Product Category(Search Key).
		@param JP_CM_ProductCategory_Value JPIERE-0629:JPPS
	*/
	public void setJP_CM_ProductCategory_Value (String JP_CM_ProductCategory_Value)
	{
		set_Value (COLUMNNAME_JP_CM_ProductCategory_Value, JP_CM_ProductCategory_Value);
	}

	/** Get Consolidated Product Category(Search Key).
		@return JPIERE-0629:JPPS
	  */
	public String getJP_CM_ProductCategory_Value()
	{
		return (String)get_Value(COLUMNNAME_JP_CM_ProductCategory_Value);
	}

	public I_JP_CM_Product getJP_CM_Product() throws RuntimeException
	{
		return (I_JP_CM_Product)MTable.get(getCtx(), I_JP_CM_Product.Table_ID)
			.getPO(getJP_CM_Product_ID(), get_TrxName());
	}
	...
	*/
	public void setJP_CM_Product_ID (int JP_CM_Product_ID)
	{
		if (JP_CM_Product_ID < 1)
			set_Value (COLUMNNAME_JP_CM_Product_ID, null);
		else
			set_Value (COLUMNNAME_JP_CM_Product_ID, Integer.valueOf(JP_CM_Product_ID));
	}
	...
	/** Set Expense Type(Search Key).
		@param JP_ExpenseType_Value Expense report type
	*/
	...
	*/
	...
	/** Set Resource(Search Key).
		@param JP_Resource_Value Resource
	*/
	...
	*/
	...
	/** Set UOM Code(Vendor).
		@param JP_VendorX12DE355 UOM EDI X12 Code
	*/
